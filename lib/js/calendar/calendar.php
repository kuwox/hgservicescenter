...
class DHTML_Calendar {
    ...
    function DHTML_Calendar($calendar_lib_path = '/calendar/',
        ...
        $this->calendar_options = array('ifFormat' => '%m/%d/%Y',
                                        'daFormat' => '%Y/%m/%d');
    }
    ...
    function make_input_field($cal_options = array(), $field_attributes = array()) {
        ...
        echo '<input ' . $attrstr .'/> <a href="#" id="'. $this->_trigger_id($id) . '">' .
            '<img align="absmiddle" border="0" src="' . $this->calendar_lib_path . 'img.gif" alt="" /></a>';
