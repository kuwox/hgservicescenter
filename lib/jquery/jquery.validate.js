...
jQuery.extend(jQuery.validator, {
	...
	messages: {
		required: "<br><span class='errormsg'>* Campo requerido</span>",
		required_fecha: "",
		remote: "Please fix this field.",
		email: "<br><span class='errormsg'>* Formato de correo invalido</span>",
		url: "Please enter a valid URL.",
		date: "&nbsp<span class='errormsg'>*</span>",
		dateISO: "<br>Please enter a valid date (ISO).",
		dateDE: "Bitte geben Sie ein gültiges Datum ein.",
		number: "<br><span class='errormsg'>* Indique solo n&uacute;meros</span>",
		numberDE: "Bitte geben Sie eine Nummer ein.",
		digits: "<br>Please enter only digits",
		creditcard: "<br>Please enter a valid credit card.",
		equalTo: "<br>Please enter the same value again.",
		accept: "<br>Please enter a value with a valid extension.",
		maxlength: jQuery.format("<br>Please enter no more than {0} characters."),
		maxLength: jQuery.format("<br>Please enter no more than {0} characters."),
		minlength: jQuery.format("<br>Indique al menos {0} caract&eacute;res."),
		minLength: jQuery.format("<br>Indique al menos {0} caract&eacute;res."),
		rangelength: jQuery.format("<br>Indique un valor entre {0} y {1} de longitud de caract&eacute;res."),
		rangeLength: jQuery.format("<br>Indique un valor entre {0} y {1} de longitud de caract&eacute;res."),
		rangeValue: jQuery.format("<br>Please enter a value between {0} and {1}."),
		range: jQuery.format("<br>Please enter a value between {0} and {1}."),
		maxValue: jQuery.format("<br>Please enter a value less than or equal to {0}."),
		max: jQuery.format("<br>Please enter a value less than or equal to {0}."),
		minValue: jQuery.format("<br>Please enter a value greater than or equal to {0}."),
		min: jQuery.format("<br>Please enter a value greater than or equal to {0}.")
	},
...
*/	
	...
	classRuleSettings: {
		...
		required_fecha: {required_fecha: true},
		email: {email: true},
		url: {url: true},
		date: {date: true},
	...
	methods: {
		...
		// http://docs.jquery.com/Plugins/Validation/Methods/required
		required_fecha: function(value, element, param) {
			// check if dependency is met
			if ( !this.depend(param, element) )
				return "dependency-mismatch";
			switch( element.nodeName.toLowerCase() ) {
