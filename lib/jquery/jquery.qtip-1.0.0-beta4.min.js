...
{var button=$(document.createElement('a')).attr('href','#').css({'float':'right','position':'relative','color':'#68BADA','text-decoration':'none', 'cursor': 'pointer'}).addClass(self.options.style.classes.button).html(self.options.content.title.button).prependTo(self.elements.title).click(self.hide);}};function assignEvents()
